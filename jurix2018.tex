...
The main function of this program is verifying the validity of the arguments in case models. The program use predicate {\mf coherent} to examine coherent arguments. This predicate is implied by {\mf coherent\_casemade}, which uses predicate {\mf member\_list} to check if the \textit{case made} by the argument in queries is logically implied by at least one case in the case list.
