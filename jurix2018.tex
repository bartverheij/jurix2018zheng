...
This program uses predicate {\mf conclusive} to verify those arguments that considered to be conclusive. According to Verheij's formalism, conclusive arguments must be coherent. In addition, if all cases in the model imply the argument's premises also imply its conclusions. In this sense, we use predicate {\mf conclusive\_casemade} to check if a case implies the argument's premises, whether it also implies the \textit{case made} by the argument. For each case in the model, we use predicate {\mf conclusive\_case\_check} to examine if it is a case implies both the premises of the argument and the case made by the argument or it doesn't imply the premises of the argument.
