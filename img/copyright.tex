...
%			draw,
	...
	\node[right] at (7,-1) {{\mf presumptively\_valid(argument([crc,ils],[l3fti,fin])).}};
	\node[right] at (7,-3) {{\mf rebutting\_attack(argument([rad,ite,pco],[ifg]),[npo]).}};
	\node[right] at (7,-5) {{\mf conclusive(argument([crc,ihe],[m3fti,fin])).}};
	\node[right] at (7,-6) {{\mf conclusive(argument([ifg,fpp],[crc])).}};
	\node[right] at (7,-7) {{\mf conclusive(argument([crc,ils,l3fti,fin,cpb],[pbt])).}};
	\node[right] at (7,-8) {{\mf conclusive(argument([crc,ils,cdt,fin,cpb],[pbt])).}};
